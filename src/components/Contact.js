    ...
    return (
        <div id="contact">
            ...
            <div className='py-10 lg:p-20'>
                ...
                <p className='text-center text-slate-800 dark:text-slate-800 font-bold p-5 2xl:px-64 2xl:text-lg'>I’m currently looking for any new opportunities, my inbox is always open. Whether you have a question or just want to say hi, <span className='text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-700 dark:from-pink-600 dark:to-purple-700'>I’ll try my best to get back to you!</span></p>
                <div className='flex justify-center p-5'>
                    <a href='mailto:reynaldo.bjsz@gmail.com' className='px-16 py-2 inline-block bg-red-800 dark:bg-red-800 text-white dark:text-white font-bold rounded-2xl border-4 border-red-800 dark:border-red-800 hover:bg-white dark:hover:bg-white hover:text-red-800 dark:hover:text-red-800 hover:border-gray-200 dark:hover:border-gray-200 shadow-lg cursor-pointer'>Say Hi!</a>
                </div>
            </div>
        </div>
    )
