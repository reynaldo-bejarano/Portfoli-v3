    ...
    <div>
      ...
      <div className='lg:flex lg:justify-center gap-10 py-20 lg:py-10' id='about'>
        <div className='lg:w-[60%]'>
          ...
          <p className='text-center lg:text-start  font-bold text-md 2xl:text-xl text-slate-700 dark:text-slate-700 py-5'>
          ...
          <p className='text-center lg:text-start  font-bold text-md 2xl:text-xl text-slate-700 dark:text-slate-700  py-1'>
            Currently pursuing a bachelor's degree in computer engineering (May 2023) with experience in Front-end development: <span className='text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-700 dark:from-pink-600 dark:to-purple-700'>HTML, CSS, JavaScript, React JS, Frameworks CSS, Firebase.</span>  Looking for an internship or a job in a technology company to expand Front-end development knowledge and gain professional experience.
          </p>
          <p className='text-center lg:text-start  font-bold text-md 2xl:text-xl text-slate-800 dark:text-slate-700 py-5'>Creative Solutions | English / Spanish | Responsive Design</p>
        </div>
        <div className='lg:w-[40%] flex justify-center py-5 '>
          <img className='rounded-3xl shadow-lg' src={image} alt="img" width={500} />
        </div>
      </div>
    </div>
  )
